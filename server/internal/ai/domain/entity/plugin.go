// Package entity AI 插件域实体（plugin 体系，剪裁多租户维度）：
...
// Skill 状态/来源常量（SkillStatus/SkillSource，字符串化存储）
const (
...
// Skill 技能（t_skill，符合 Agent Skills 开放规范）
//
...
// SkillResource 技能资源（FsBackend /skills/{code}/... 的 DB 存储形态）
//
...
type SkillResource struct {
	...
	// Size 内容字节大小（UpsertResourceRequest.size）
