...
func (m *MachineCronJob) MachineCronJobs(rc *req.Ctx) {
	cond, pageParam := rc.BindQueryAndPage[entity.MachineCronJob]()
...
func (m *MachineCronJob) Save(rc *req.Ctx) {
	jobForm, mcj := rc.BindJsonAndCopyTo[form.MachineCronJobForm, entity.MachineCronJob]()
	rc.ReqParam = jobForm
...
func (m *MachineCronJob) CronJobExecs(rc *req.Ctx) {
	cond, pageParam := rc.BindQueryAndPage[entity.MachineCronJobExec]()
