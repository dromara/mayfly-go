...
func TestPostgresGenTruncate(t *testing.T) {
	gen := newTestSQLGenerator(DbTypePostgres)
...
func TestPostgresGenBatchDelete_SinglePK(t *testing.T) {
	gen := newTestSQLGenerator(DbTypePostgres)
...
func TestPostgresGenBatchDelete_CompositePK(t *testing.T) {
	gen := newTestSQLGenerator(DbTypePostgres)
...
func TestPostgresGenBatchDelete_EmptyInput(t *testing.T) {
	gen := newTestSQLGenerator(DbTypePostgres)
