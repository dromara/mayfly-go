...
BEGIN;
 ...
 INSERT INTO `t_sys_config` (`id`, `name`, `key`, `params`, `value`, `remark`, `permission`, `create_time`, `creator_id`, `creator`, `update_time`, `modifier_id`, `modifier`, `is_deleted`, `delete_time`) values(8, 'system.sysconf.dbmsConf', 'DbmsConfig', '{"version":1,"cols":2,"fields":[{"prop":"querySqlSave","label":"system.sysconf.recordQuerySql","type":"select","options":[{"label":"true","value":"true"},{"label":"false","value":"false"}]},{"prop":"sqlExecTl","label":"system.sysconf.sqlExecLimt"},{"prop":"maxResultSet","label":"system.sysconf.maxResultSet"},{"prop":"maskEnabled","label":"system.sysconf.maskEnabled","type":"select","options":[{"label":"true","value":"true"},{"label":"false","value":"false"}],"tooltip":"system.sysconf.maskEnabledPlaceholder"},{"prop":"maskFailClosed","label":"system.sysconf.maskFailClosed","type":"select","options":[{"label":"true","value":"true"},{"label":"false","value":"false"}],"tooltip":"system.sysconf.maskFailClosedPlaceholder"},{"prop":"maskExemptRoleIds","label":"system.sysconf.maskExemptRoleIds","tooltip":"system.sysconf.maskExemptRoleIdsPlaceholder"}]}', '{"querySqlSave":"false","maxResultSet":"0","sqlExecTl":"60","maskEnabled":"false","maskFailClosed":"false","maskExemptRoleIds":""}', 'system.sysconf.dbmsConfRemark', 'admin,', '2024-03-06 13:30:51', 1, 'admin', '2024-03-06 14:07:16', 1, 'admin', 0, NULL);
 INSERT INTO `t_sys_config` (`id`, `name`, `key`, `params`, `value`, `remark`, `permission`, `create_time`, `creator_id`, `creator`, `update_time`, `modifier_id`, `modifier`, `is_deleted`, `delete_time`) values(9, 'system.sysconf.fileConf', 'FileConfig', '[{"model":"basePath","name":"system.sysconf.basePath","placeholder":"system.sysconf.baesPathPlaceholder"},{"model":"s3Endpoint","name":"system.sysconf.s3Endpoint","placeholder":"system.sysconf.s3EndpointPlaceholder","required":false},{"model":"s3Region","name":"system.sysconf.s3Region","placeholder":"system.sysconf.s3RegionPlaceholder","required":false},{"model":"s3Bucket","name":"system.sysconf.s3Bucket","placeholder":"system.sysconf.s3BucketPlaceholder","required":false},{"model":"s3AccessKey","name":"system.sysconf.s3AccessKey","placeholder":"system.sysconf.s3AccessKeyPlaceholder","required":false},{"model":"s3SecretKey","name":"system.sysconf.s3SecretKey","placeholder":"system.sysconf.s3SecretKeyPlaceholder","required":false},{"model":"s3PathStyle","name":"system.sysconf.s3PathStyle","placeholder":"system.sysconf.s3PathStylePlaceholder","options":"true,false","required":false}]', '{"basePath":"./file"}', 'system.sysconf.fileConfRemark', 'admin,', '2024-10-20 22:30:01', 1, 'admin', '2024-10-21 13:51:17', 1, 'admin', 0, NULL);
COMMIT;
