...
func initResource(tx *gorm.DB) error {
	resources := []*sysentity.Resource{
		...
		// ===== 告警模块菜单 =====
		{
			Model:  model.Model{CreateModel: model.CreateModel{DeletedModel: model.DeletedModel{IdModel: model.IdModel{Id: 1730000001}}}},
			Pid:    0,
			UiPath: "Alert001/",
			Name:   "menu.alert",
			Code:   "/alert",
			Type:   1,
			Meta:   `{"icon":"Bell","isKeepAlive":true,"routeName":"Alert"}`,
			Weight: 49999997,
		},
		{
			Model:  model.Model{CreateModel: model.CreateModel{DeletedModel: model.DeletedModel{IdModel: model.IdModel{Id: 1730000002}}}},
			Pid:    1730000001,
			UiPath: "Alert001/Alrt0001/",
			Name:   "menu.alertOverview",
			Code:   "alert-overview",
			Type:   1,
			Meta:   `{"component":"ops/alert/AlertOverview","icon":"DataLine","isKeepAlive":true,"routeName":"AlertOverview"}`,
			Weight: 10000000,
		},
		{
			Model:  model.Model{CreateModel: model.CreateModel{DeletedModel: model.DeletedModel{IdModel: model.IdModel{Id: 1730000003}}}},
			Pid:    1730000001,
			UiPath: "Alert001/Alrt0002/",
			Name:   "menu.alertRule",
			Code:   "alert-rules",
			Type:   1,
			Meta:   `{"component":"ops/alert/AlertRuleList","icon":"Setting","isKeepAlive":true,"routeName":"AlertRuleList"}`,
			Weight: 20000000,
		},
		{
			Model:  model.Model{CreateModel: model.CreateModel{DeletedModel: model.DeletedModel{IdModel: model.IdModel{Id: 1730000004}}}},
			Pid:    1730000001,
			UiPath: "Alert001/Alrt0003/",
			Name:   "menu.alertEvent",
			Code:   "alert-events",
			Type:   1,
			Meta:   `{"component":"ops/alert/AlertEventList","icon":"Warning","isKeepAlive":true,"routeName":"AlertEventList"}`,
			Weight: 30000000,
		},
		{
			Model:  model.Model{CreateModel: model.CreateModel{DeletedModel: model.DeletedModel{IdModel: model.IdModel{Id: 1730000005}}}},
			Pid:    1730000001,
			UiPath: "Alert001/Alrt0004/",
			Name:   "menu.alertSilence",
			Code:   "alert-silences",
			Type:   1,
			Meta:   `{"component":"ops/alert/AlertSilenceList","icon":"Mute","isKeepAlive":true,"routeName":"AlertSilenceList"}`,
			Weight: 40000000,
		},
		{
			Model:  model.Model{CreateModel: model.CreateModel{DeletedModel: model.DeletedModel{IdModel: model.IdModel{Id: 1730000006}}}},
			Pid:    1730000001,
			UiPath: "Alert001/Alrt0005/",
			Name:   "menu.alertEscalation",
			Code:   "alert-escalations",
			Type:   1,
			Meta:   `{"component":"ops/alert/AlertEscalationList","icon":"TopRight","isKeepAlive":true,"routeName":"AlertEscalationList"}`,
			Weight: 50000000,
		},
		{
			Model:  model.Model{CreateModel: model.CreateModel{DeletedModel: model.DeletedModel{IdModel: model.IdModel{Id: 1730000007}}}},
			Pid:    1730000001,
			UiPath: "Alert001/Alrt0006/",
			Name:   "menu.alertInhibition",
			Code:   "alert-inhibitions",
			Type:   1,
			Meta:   `{"component":"ops/alert/AlertInhibitionList","icon":"SwitchButton","isKeepAlive":true,"routeName":"AlertInhibitionList"}`,
			Weight: 60000000,
		},
		{
			Model:  model.Model{CreateModel: model.CreateModel{DeletedModel: model.DeletedModel{IdModel: model.IdModel{Id: 1730000010}}}},
			Pid:    1730000003,
			UiPath: "Alert001/Alrt0002/Rule0001/",
			Name:   "menu.alertRuleBase",
			Code:   "alert:rule",
			Type:   2,
			Weight: 10000000,
		},
		{
			Model:  model.Model{CreateModel: model.CreateModel{DeletedModel: model.DeletedModel{IdModel: model.IdModel{Id: 1730000011}}}},
			Pid:    1730000003,
			UiPath: "Alert001/Alrt0002/Rule0002/",
			Name:   "menu.alertRuleSave",
			Code:   "alert:rule:save",
			Type:   2,
			Weight: 20000000,
		},
		{
			Model:  model.Model{CreateModel: model.CreateModel{DeletedModel: model.DeletedModel{IdModel: model.IdModel{Id: 1730000012}}}},
			Pid:    1730000003,
			UiPath: "Alert001/Alrt0002/Rule0003/",
			Name:   "menu.alertRuleDelete",
			Code:   "alert:rule:del",
			Type:   2,
			Weight: 30000000,
		},
		{
			Model:  model.Model{CreateModel: model.CreateModel{DeletedModel: model.DeletedModel{IdModel: model.IdModel{Id: 1730000020}}}},
			Pid:    1730000004,
			UiPath: "Alert001/Alrt0003/Evt00001/",
			Name:   "menu.alertEventBase",
			Code:   "alert:event",
			Type:   2,
			Weight: 10000000,
		},
		{
			Model:  model.Model{CreateModel: model.CreateModel{DeletedModel: model.DeletedModel{IdModel: model.IdModel{Id: 1730000021}}}},
			Pid:    1730000004,
			UiPath: "Alert001/Alrt0003/Evt00002/",
			Name:   "menu.alertEventAck",
			Code:   "alert:event:ack",
			Type:   2,
			Weight: 20000000,
		},
		{
			Model:  model.Model{CreateModel: model.CreateModel{DeletedModel: model.DeletedModel{IdModel: model.IdModel{Id: 1730000030}}}},
			Pid:    1730000005,
			UiPath: "Alert001/Alrt0004/Sil00001/",
			Name:   "menu.alertSilenceBase",
			Code:   "alert:silence",
			Type:   2,
			Weight: 10000000,
		},
		{
			Model:  model.Model{CreateModel: model.CreateModel{DeletedModel: model.DeletedModel{IdModel: model.IdModel{Id: 1730000031}}}},
			Pid:    1730000005,
			UiPath: "Alert001/Alrt0004/Sil00002/",
			Name:   "menu.alertSilenceSave",
			Code:   "alert:silence:save",
			Type:   2,
			Weight: 20000000,
		},
		{
			Model:  model.Model{CreateModel: model.CreateModel{DeletedModel: model.DeletedModel{IdModel: model.IdModel{Id: 1730000032}}}},
			Pid:    1730000005,
			UiPath: "Alert001/Alrt0004/Sil00003/",
			Name:   "menu.alertSilenceDelete",
			Code:   "alert:silence:del",
			Type:   2,
			Weight: 30000000,
		},
		{
			Model:  model.Model{CreateModel: model.CreateModel{DeletedModel: model.DeletedModel{IdModel: model.IdModel{Id: 1730000040}}}},
			Pid:    1730000006,
			UiPath: "Alert001/Alrt0005/Esc00001/",
			Name:   "menu.alertEscalationBase",
			Code:   "alert:escalation",
			Type:   2,
			Weight: 10000000,
		},
		{
			Model:  model.Model{CreateModel: model.CreateModel{DeletedModel: model.DeletedModel{IdModel: model.IdModel{Id: 1730000041}}}},
			Pid:    1730000006,
			UiPath: "Alert001/Alrt0005/Esc00002/",
			Name:   "menu.alertEscalationSave",
			Code:   "alert:escalation:save",
			Type:   2,
			Weight: 20000000,
		},
		{
			Model:  model.Model{CreateModel: model.CreateModel{DeletedModel: model.DeletedModel{IdModel: model.IdModel{Id: 1730000042}}}},
			Pid:    1730000006,
			UiPath: "Alert001/Alrt0005/Esc00003/",
			Name:   "menu.alertEscalationDelete",
			Code:   "alert:escalation:del",
			Type:   2,
			Weight: 30000000,
		},
		{
			Model:  model.Model{CreateModel: model.CreateModel{DeletedModel: model.DeletedModel{IdModel: model.IdModel{Id: 1730000050}}}},
			Pid:    1730000007,
			UiPath: "Alert001/Alrt0006/Inh00001/",
			Name:   "menu.alertInhibitionBase",
			Code:   "alert:inhibition",
			Type:   2,
			Weight: 10000000,
		},
		{
			Model:  model.Model{CreateModel: model.CreateModel{DeletedModel: model.DeletedModel{IdModel: model.IdModel{Id: 1730000051}}}},
			Pid:    1730000007,
			UiPath: "Alert001/Alrt0006/Inh00002/",
			Name:   "menu.alertInhibitionSave",
			Code:   "alert:inhibition:save",
			Type:   2,
			Weight: 20000000,
		},
		{
			Model:  model.Model{CreateModel: model.CreateModel{DeletedModel: model.DeletedModel{IdModel: model.IdModel{Id: 1730000052}}}},
			Pid:    1730000007,
			UiPath: "Alert001/Alrt0006/Inh00003/",
			Name:   "menu.alertInhibitionDelete",
			Code:   "alert:inhibition:del",
			Type:   2,
			Weight: 30000000,
		},
	}
