...
}`;const Ke={setCss:()=>{let e=document.createElement("link");e.rel="stylesheet",e.href=pi,e.crossOrigin="anonymous",document.getElementsByTagName("head")[0].appendChild(e)},start:()=>{const e=document.body,t=document.createElement("div");t.setAttribute("class","loading-next");const l=`
...
.layout-navbars-breadcrumb-user-news .head-box .head-box-btn[data-v-9050d0f4] {
  color: var(--color-primary);
  font-size: 13px;
  cursor: pointer;
  opacity: 0.8;
}
.layout-navbars-breadcrumb-user-news .head-box .head-box-btn[data-v-9050d0f4]:hover {
  opacity: 1;
}
.layout-navbars-breadcrumb-user-news .content-box[data-v-9050d0f4] {
  font-size: 13px;
}
.layout-navbars-breadcrumb-user-news .content-box .content-box-item[data-v-9050d0f4] {
  padding-top: 12px;
}
.layout-navbars-breadcrumb-user-news .content-box .content-box-item[data-v-9050d0f4]:last-of-type {
  padding-bottom: 12px;
}
.layout-navbars-breadcrumb-user-news .content-box .content-box-item .content-box-msg[data-v-9050d0f4] {
  color: #999999;
  margin-top: 5px;
  margin-bottom: 5px;
}
.layout-navbars-breadcrumb-user-news .content-box .content-box-item .content-box-time[data-v-9050d0f4] {
  color: #999999;
}
.layout-navbars-breadcrumb-user-news .foot-box[data-v-9050d0f4] {
  height: 35px;
  color: var(--color-primary);
  font-size: 13px;
  cursor: pointer;
