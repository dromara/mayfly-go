import { getSqlScanZone, maskSqlComments, SqlSplitOptions, splitSqlStatements } from '../sql-editor/utils/sqlParser';
import { commonQuotePairs } from '../dialect/shared/capabilities';
import { stripIdentifierQuotes } from './quoter';
...
/** 光标所处区域 */
type CursorZone = 'code' | 'string' | 'comment';
