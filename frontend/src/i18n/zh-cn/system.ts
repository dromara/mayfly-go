export default {
    system: {
        ...
        sysconf: {
            ...
            s3Endpoint: 'S3服务地址',
            s3EndpointPlaceholder: 'S3兼容对象存储地址，如 http://127.0.0.1:9000。与以下s3配置项均填写时启用s3存储，否则使用本地存储',
            s3Region: 'S3区域',
            s3RegionPlaceholder: 'S3区域，默认 us-east-1',
            s3Bucket: 'S3存储桶',
            s3BucketPlaceholder: 'S3存储桶名称',
            s3AccessKey: 'S3 AccessKey',
            s3AccessKeyPlaceholder: 'S3访问密钥AccessKey',
            s3SecretKey: 'S3 SecretKey',
            s3SecretKeyPlaceholder: 'S3访问密钥SecretKey',
            s3PathStyle: 'S3 Path-Style',
            s3PathStylePlaceholder: '是否使用path-style访问，minio等自建存储一般为true',
            ...
            aiApiKey: 'API Key',
            aiMaxTokens: '最大输出Tokens',
            aiMaxTokensPlaceholder: '留空则不限制（使用模型服务端默认上限）',
