export default {
    system: {
        ...
        sysconf: {
            ...
            s3Bucket: 'S3 Bucket',
            s3BucketPlaceholder: 'S3 bucket name',
            s3AccessKey: 'S3 AccessKey',
            s3AccessKeyPlaceholder: 'S3 access key',
            s3SecretKey: 'S3 SecretKey',
            s3SecretKeyPlaceholder: 'S3 secret key',
            s3PathStyle: 'S3 Path-Style',
            s3PathStylePlaceholder: 'Whether to use path-style access, generally true for self-hosted storage such as MinIO',
            ...
            aiMaxTokensPlaceholder: 'Leave empty for no limit (use the model server default)',
