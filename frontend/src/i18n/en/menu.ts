export default {
    menu: {
        ...
        alertRuleBase: 'Rule - Base Permission',
        alertRuleSave: 'Rule - Save',
        alertRuleDelete: 'Rule - Delete',
        alertEvent: 'Alert Events',
        alertEventBase: 'Event - Base Permission',
        alertEventAck: 'Event - Acknowledge',
        alertSilence: 'Silence Rules',
        alertSilenceBase: 'Silence - Base Permission',
        alertSilenceSave: 'Silence - Save',
        alertSilenceDelete: 'Silence - Delete',
        alertEscalation: 'Escalation Policies',
        alertEscalationBase: 'Escalation - Base Permission',
        alertEscalationSave: 'Escalation - Save',
        alertEscalationDelete: 'Escalation - Delete',
        alertInhibition: 'Inhibition Rules',
        alertInhibitionBase: 'Inhibition - Base Permission',
        alertInhibitionSave: 'Inhibition - Save',
        alertInhibitionDelete: 'Inhibition - Delete',
        alertNotifyPolicy: 'Notify Policies',
        alertNotifyPolicyBase: 'Notify Policy - Base Permission',
        alertNotifyPolicySave: 'Notify Policy - Save',
        alertNotifyPolicyDelete: 'Notify Policy - Delete',
    },
};
